...
1. The original bash script: .zo/scripts/bash/create-new-feature.sh
2. The new Python script: .zo/scripts/python/create-new-feature.py

Usage: python create-new-feature.test.py
"""
...
BASH_SCRIPT = SCRIPT_DIR.parent / "bash" / "create-new-feature.sh"
PYTHON_SCRIPT = SCRIPT_DIR / "create-new-feature.py"
...
def setup_test_template():
    """Create test template for spec-template."""
...
def run_all_tests():
    ...
    print("\n" + BOLD + "=" * 60 + RESET)
    print(BOLD + "CREATE-NEW-FEATURE TEST SUITE" + RESET)
    print(BOLD + "=" * 60 + RESET)
